    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <br />
                Sect_Name = <asp:Label ID="lblSect_Name" runat="server" ></asp:Label>
                <br />
                Sect_Desc = <asp:Label ID="lblSect_Desc" runat="server" ></asp:Label>
                <br />
                Sect_Active = <asp:Label ID="lblSect_Active" runat="server" ></asp:Label>
                <br />
