    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <br />
                Cat_Id =
                <asp:Label ID="lblCat_Id" runat="server"></asp:Label>
                <br />
                Item_Name =
                ...
                <br />
                Item_Allergens =
                <asp:Label ID="lblItem_Allergens" runat="server"></asp:Label>
                <br />
                Item_Price =
                <asp:Label ID="lblItem_Price" runat="server"></asp:Label>
                <br />
                Item_Gluten_Free =
                <asp:Label ID="lblItem_Gluten_Free" runat="server"></asp:Label>
                <br />
                Item_Active =
                <asp:Label ID="lblItem_Active" runat="server"></asp:Label>
                <br />
