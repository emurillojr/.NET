    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <br />
                User_Email = <asp:Label ID="lblUser_Email" runat="server" ></asp:Label>
                <br />
                User_First = <asp:Label ID="lblUser_First" runat="server" ></asp:Label>
                <br />
                User_Last = <asp:Label ID="lblUser_Last" runat="server" ></asp:Label>
                <br />
                User_Add1 = <asp:Label ID="lblUser_Add1" runat="server" ></asp:Label>
                <br />
                User_Add2 = <asp:Label ID="lblUser_Add2" runat="server" ></asp:Label>
                <br />
                User_City = <asp:Label ID="lblUser_City" runat="server" ></asp:Label>
                <br />
                State_ID = <asp:Label ID="lblState_ID" runat="server" ></asp:Label>
                <br />
                User_Zip = <asp:Label ID="lblUser_Zip" runat="server" ></asp:Label>
                <br />
                User_Phone = <asp:Label ID="lblUser_Phone" runat="server" ></asp:Label>
                <br />
                User_Active = <asp:Label ID="lblUser_Active" runat="server" ></asp:Label>
                <br />
...
<%--states will need to be added to server--%>
                ...
                <div class="form-group">
                    <div class="col-lg-10 col-lg-offset-2">
                        ...
                        <asp:LinkButton ID="lbtnUpdate" runat="server" CssClass="btn btn-success">Update</asp:LinkButton>
