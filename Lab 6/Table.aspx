    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <br />
                Sect_ID = <asp:Label ID="lblSect_ID" runat="server" ></asp:Label>
                <br />
                Tbl_Name = <asp:Label ID="lblTbl_Name" runat="server" ></asp:Label>
                <br />
                Tbl_Desc = <asp:Label ID="lblTbl_Desc" runat="server" ></asp:Label>
                <br />
                Tbl_Seat_Cnt = <asp:Label ID="lblTbl_Seat_Cnt" runat="server" ></asp:Label>
                <br />
                Tbl_Active = <asp:Label ID="lblTbl_Active" runat="server" ></asp:Label>
                <br />
...
<%--                        <asp:DropDownList ID="ddlSection" runat="server" CssClass="form-control">
                            ...
                            <%--made a blank entry for rfv test--%>
