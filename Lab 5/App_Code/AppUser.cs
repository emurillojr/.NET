...
namespace SE256demoWEEK1
{
    public class AppUser
    {
        ...
        public AppUser(string email)   // define one input parameter of type String named Email 
        {
            ...
            //try
            //{
            //    // set all property values from the DataTable.Row[0] returned.
            //    this.UserId = Convert.ToInt32(dt.Rows[0]["user_id"]);
            //    this.Email = Convert.ToString(dt.Rows[0]["user_email"]);
            //    this.Salt = Convert.ToString(dt.Rows[0]["user_salt"]);
            //    this.FirstName = Convert.ToString(dt.Rows[0]["user_first"]);
            //    this.LastName = Convert.ToString(dt.Rows[0]["user_last"]);
            //    this.HashedPassword = Convert.ToString(dt.Rows[0]["user_pwd"]);
            //    this.ValidLogin = false;
